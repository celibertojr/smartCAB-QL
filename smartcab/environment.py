    ...
    def step(self):
        ...
        if self.primary_agent is not None:
            if self.enforce_deadline and self.agent_states[self.primary_agent]['deadline'] <= 0:
                ...
                self.primary_agent.countFail += 1

                with open("CabResults.txt", "a") as myfile:
                    myfile.write("Primary agent could not reach destination within deadline!" + " Fail :"+
                    str(self.primary_agent.countFail) + "\n")
            ...
            if state['location'] == state['destination']:
                ...
                with open("CabResults.txt", "a") as myfile:
                    myfile.write("Primary agent has reached destination! : "+
                        ...
                        str(self.primary_agent.storageRewards)+"\n")
